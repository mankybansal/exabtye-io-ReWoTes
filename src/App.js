    ...
    return (
      <div className="App">
        <div className="App-header">
          <div className="nav" onClick={this.toggleSideBar}>
          ...
          <div className="App-avatar">
            <div className="App-avatar-text">
              {" "}
              Mayank Bansal &nbsp; <FontAwesomeIcon icon={faAngleDown} />
            </div>
        ...
        {this.state.sideBarInit  ? (
          <div className={this.state.sideBar ? "SideBar-Container show" : null}>
            <div
              className={
                this.state.sideBar
                  ? "SideBar animated slideInLeft"
                  : "SideBar animated slideOutLeft"
              }
            >
              {this.loadSideBar()}
            </div>
            ...
            <div
              className={
                this.state.sideBar
                  ? "SideBar-Clickable animated fadeIn"
                  : "SideBar-Clickable animated fadeOut"
              }
        ...
        <div
          className={
            this.state.sideBar && this.state.sideBarInit
              ? "App-container App-container-push"
              : "App-container"
          }
        >
          <div className="App-menu">{this.loadDesignerMenu()}</div>
          ...
          <div className="App-editor-container">
            <div className="App-editor-code">
              {this.state.ProjectBar ? (
                <div className="projectBar">
                  ...
                  <br />
                  <FontAwesomeIcon
                    className="project-folder-icon project-push"
                    icon={faFile}
                  />{" "}
                  &nbsp;
              ...
              <div className="container-titlebar">
                ...
                <div
                  onClick={this.toggleSyncHandler}
                  className="container-titlebar-control"
                >
                  {this.state.sync ? (
                    <FontAwesomeIcon icon={faSync} className="ctrlActive" />
                  ) : (
                ...
                >
                  {this.state.sync ? (
                    <FontAwesomeIcon icon={faSave} className="ctrlActive" />
                  ) : (
            ...
            <div className="viewer-controls">
              ...
              <div onClick={this.toggleAxesHandler} className="viewer-ctrl">
                {this.state.axes ? (
                  <FontAwesomeIcon icon={faAsterisk} className="ctrlActive" />
                ) : (
              ...
              <div onClick={this.toggleBoundHandler} className="viewer-ctrl">
                {this.state.boundingBox ? (
                  <FontAwesomeIcon icon={faCube} className="ctrlActive" />
                ) : (
              ...
              <div onClick={this.rotateHandler} className="viewer-ctrl">
                {this.state.viewerRotate ? (
                  <FontAwesomeIcon icon={faPause} className="ctrlActive" />
                ) : (
      ...
      return (
        <div key={key} className="App-menu-item">
          ...
          <div className="MenuDropDown">
            {Object.entries(value.dropDowns).map(
              ([dropDownKey, dropDownValue], j) => {
                return (
    ...
    return Object.entries(sideBarItems).map(([key, value], i) => {
      return (
        <div
          ...
          className={
            this.state.sideBar
              ? "SideBar-Item animated fadeInLeft"
              : "SideBar-Item"
          }
        >
